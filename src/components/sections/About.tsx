...
export function AboutSection() {
  ...
  return (
    <section id="about" className="relative py-20 sm:py-24 lg:py-28">
      <Container>
        <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-8 xl:gap-12">
          ...
          <motion.div className="order-2 lg:order-2" {...sectionHeadingMotion}>
            <div className="mb-4 flex items-center gap-3">
              <span className="system-label">Profile / 02</span>
              <span className="system-rule" />
            </div>
            <p className="system-kicker mb-3">About</p>
